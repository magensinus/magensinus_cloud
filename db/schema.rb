...
ActiveRecord::Schema.define(version: 2022_03_16_093020) do
  ...
  create_table "journal_articles", force: :cascade do |t|
    ...
    t.boolean "erasmus", default: false
  ...
  create_table "magensinus_about_assets", force: :cascade do |t|
    t.string "slug"
    t.integer "position"
    t.string "alignment"
    t.boolean "text"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["slug"], name: "index_magensinus_about_assets_on_slug"
  end
  ...
  create_table "magensinus_terms_and_conditions", force: :cascade do |t|
    t.string "slug"
    t.string "meta_title"
    t.text "meta_description"
    t.string "meta_image_box"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["slug"], name: "index_magensinus_terms_and_conditions_on_slug"
  end
  ...
  create_table "magestil_quality", force: :cascade do |t|
    t.string "slug"
    t.string "meta_title"
    t.text "meta_description"
    t.string "meta_image_box"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["slug"], name: "index_magestil_quality_on_slug"
  end
